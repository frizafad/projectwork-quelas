      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow mb-5">
            ...
            <div class="card-body">
            <form action="{{ route('postEditw') }}" method="post">
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
                <!-- Address -->
                  ...
                  {{-- <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control form-control-regular" name="password" value="{{ Auth::user()->password }}" type="password" required>
                      </div>
                    </div>
                  </div> --}}
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group pt-3 mb-0">
                        <input class="btn btn-icon btn-3 btn-primary" type="submit" value="Edit Profile" required>
                      </div>
                    </div>
                  </div>
                </div>
